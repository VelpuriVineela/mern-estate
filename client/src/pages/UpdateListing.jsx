...
export default function CreateListing() {
  ...
  //params is used for to have the id in the route
  ...
  // to fetch the data of listing on the page before editing(automatically filled the prev data)
  useEffect(() => {
    //async function inside useeffect gives error so we write the async function inside the callback
